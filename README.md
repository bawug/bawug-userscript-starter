...
- See the [User scripts directory](https://en.wikipedia.org/wiki/Wikipedia:User_scripts/List) for hundreds of real examples.
- Use [`mw.Api`](https://doc.wikimedia.org/mediawiki-core/master/js/mw.Api.html) to read or edit pages from the script.
- Use [`mw.hook`](https://www.mediawiki.org/wiki/Manual:JavaScript_hooks) to react to events like `wikipage.content`.
